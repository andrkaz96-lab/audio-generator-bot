...
SYSTEM_PROMPT_AUDIO_ADAPTED = (
    ...
    "10) После заголовка добавь короткое вступление (1–2 предложения), объясняющее тему статьи.\n"
    "11) В конце добавь короткий итог (1–2 предложения), подводящий итог основным мыслям.\n"
    "12) Верни только plain text в формате:\n"
    "заголовок\n\n"
    "вступление\n\n"
    "основной текст\n\n"
    "итог."
